...
cbuffer _Globals : register(b0)
{
  ...
  float BlendMulScale2 : packoffset(c62.z) = {1};
  float CubeMapIntensity : packoffset(c62.w) = {1};
  float CubeMapFresnel : packoffset(c63) = {0};
  float BloomIntensity : packoffset(c63.y) = {1};
