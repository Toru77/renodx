...
cbuffer _Globals : register(b0)
{
  ...
  float BlendMulScale2 : packoffset(c59.z) = {1};
  float CubeMapIntensity : packoffset(c59.w) = {1};
  float CubeMapFresnel : packoffset(c60) = {0};
  float BloomIntensity : packoffset(c60.y) = {1};
