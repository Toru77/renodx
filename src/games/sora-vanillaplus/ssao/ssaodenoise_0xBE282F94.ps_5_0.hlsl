  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.x = 0;
  while (true) {
    r3.y = cmp((uint)r3.x >= 15);
    if (r3.y != 0) break;
    r3.yz = offsetsAndWeights[r3.x].xy + v1.xy;
    r0.z = depthTexture.SampleLevel(samLinear_s, r3.yz, 0).x;
    r3.w = dot(projInv_g._m22_m32, r0.zw);
    r0.z = dot(projInv_g._m23_m33, r0.zw);
    r0.z = r3.w / r0.z;
    r0.z = r0.z + -r0.x;
    r0.z = cmp(abs(r0.z) < 0.075000003);
    r0.z = r0.z ? 1 : r0.y;
    r4.xyzw = offsetsAndWeights[r3.x].zzww * r0.zzzz;
    r5.xyzw = colorTexture.SampleLevel(samLinear_s, r3.yz, 0).xyzw;
    r2.xyzw = r0.zzzz * offsetsAndWeights[r3.x].zzww + r2.xyzw;
    r1.xyzw = r5.xyzw * r4.xyzw + r1.xyzw;
    r3.x = (int)r3.x + 1;
  }
  r0.xyzw = cmp(r2.xyzw == float4(0,0,0,0));
