// ---- Created with 3Dmigoto v1.4.1 on Mon Mar 30 06:01:15 2026
...
cbuffer _Globals : register(b0)
{
  ...
  float4 LuminanceParam : packoffset(c3);
  float3 SpeculerScale : packoffset(c4);
}
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  o0.xyz = renodx::tonemap::Reinhard(o0.xyz);
  return;
}