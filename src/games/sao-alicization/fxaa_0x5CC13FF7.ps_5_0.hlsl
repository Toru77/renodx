  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = max(r2.w, r0.w);
  r1.w = min(r3.x, r1.w);
  r2.w = 0.100000001 * r0.w;
  r0.w = -r1.w + r0.w;
  r1.w = max(0.0833000019, r2.w);
  r1.w = cmp(r0.w >= r1.w);
  if (r1.w != 0) {
    ColorBuffer.GetDimensions(0, fDest.x, fDest.y, fDest.z);
    r3.xy = fDest.xy;
    r3.xy = float2(1,1) / r3.xy;
    r1.w = ColorBuffer.SampleLevel(LinearClampSampler_s, v1.xy, 0, int2(1, -1)).y;
    r2.w = ColorBuffer.SampleLevel(LinearClampSampler_s, v1.xy, 0, int2(-1, 1)).y;
    r3.zw = r2.yx + r1.xz;
    r0.w = 1 / r0.w;
    r4.x = r3.z + r3.w;
    ...
    r5.y = r3.y + r2.z;
    r3.x = r0.w * -2 + 3;
    r3.y = ColorBuffer.SampleLevel(LinearClampSampler_s, r4.xy, 0).y;
    r0.w = r0.w * r0.w;
    r3.z = ColorBuffer.SampleLevel(LinearClampSampler_s, r5.xy, 0).y;
    r1.x = r2.w ? r2.x : r1.x;
    r2.x = 0.25 * r2.y;
    r2.y = -r1.x * 0.5 + r0.y;
    r0.w = r3.x * r0.w;
    ...
    if (r2.w != 0) {
      if (r3.z == 0) {
        r3.x = ColorBuffer.SampleLevel(LinearClampSampler_s, r4.xz, 0).y;
      }
      if (r3.w == 0) {
        r3.y = ColorBuffer.SampleLevel(LinearClampSampler_s, r4.yw, 0).y;
      }
      r2.w = -r1.x * 0.5 + r3.x;
      r3.x = r3.z ? r3.x : r2.w;
      r2.w = -r1.x * 0.5 + r3.y;
