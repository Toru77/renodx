// ---- Created with 3Dmigoto v1.4.1 on Thu Aug  6 13:20:09 2026
// DLAA patch: adds per-object motion output to o3/SV_TARGET3 (appended 16-bit
// motion RTV) from TEXCOORD5 (prevClip emitted by the replaced char VS). The
// game's o0/o1/o2 (color, normal, encoded-depth) are untouched.
...
void main(
  ...
  float4 v7 : TEXCOORD5,  // DLAA: prevClip from replaced char VS (o7)
