...
void main(
  ...
  float4 v9 : TEXCOORD5,  // DLAA: prevClip from replaced char VS
  ...
  out float4 o3 : SV_TARGET3)  // DLAA: appended per-object motion target
{
        ...
        if (r3.w != 0) {
          ...
          if (r3.w != 0) {
            ...
            if (r4.x != 0) {
              ...
              r4.w = LightShadowMap0.SampleCmpLevelZero(LinearClampCmpSamplerState_s, r8.xy, r8.z).x;
              r4.z = r4.w * 0.0625 + r4.z;
              r8.xy = r4.xy * r1.ww;
              r8.z = 0;
              r4.xyw = r8.xyz + r3.xyz;
  ...
  r3.w = dot(r3.xyz, r0.xyw);
  r0.x = cmp(r3.w < 0);
  r3.xyzw = r0.xxxx ? -r3.xyzw : r3.xyzw;
  r0.x = dot(LightDirForChar.xyz, r3.xyz);
  r0.x = r0.x * 0.5 + 0.5;
  r0.y = 0;
  r0.x = CartoonMapSampler.SampleLevel(LinearClampSamplerState_s, r0.xy, 0).x;
  r0.xyw = Light0.m_colorIntensity.xyz * r0.xxx + scene.GlobalAmbientColor.xyz;
  r0.xyw = min(PerMaterialMainLightClampFactor, r0.xyw);
  r0.z = 1 + -r0.z;
