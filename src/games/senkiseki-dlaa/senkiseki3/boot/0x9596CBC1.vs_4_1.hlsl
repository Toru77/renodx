...
cbuffer _Globals : register(b0)
{
  ...
  float FogRatio : packoffset(c60.y) = {1};
  float2 ProjectionScale : packoffset(c60.z) = {1,1};
  float BloomIntensity : packoffset(c61) = {1};
  ...
  out float4 o7 : TEXCOORD10)
{
  ...
  r2.xyz = scene.EyePosition.xyz + -r0.xyz;
  ...
  o4.xyz = r0.xyz;
  r0.xy = r0.xz / ProjectionScale.xy;
  o5.xy = UVaProjTexcoord.xy + r0.xy;
