...
cbuffer _Globals : register(b0)
{
  ...
  float ShadowReceiveOffset : packoffset(c65.z) = {0.600000024};
  float BloomIntensity : packoffset(c65.w) = {0.699999988};
  float4 GameEdgeParameters : packoffset(c66) = {1,1,1,0.00300000003};
  float4 OutlineColorFactor : packoffset(c67) = {1,1,1,1};
  float3 OutlineColor : packoffset(c68) = {0.699999988,0.5,0.300000012};
