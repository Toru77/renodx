...
cbuffer _Globals : register(b0)
{
  ...
  float3 ShadowColorShift : packoffset(c75) = {0.100000001,0.0199999996,0.0199999996};
  float Shininess : packoffset(c75.w) = {0.5};
  float SpecularPower : packoffset(c76) = {50};
  float3 SpecularColor : packoffset(c76.y) = {1,1,1};
  ...
  float ShadowReceiveOffset : packoffset(c78.z) = {0.600000024};
  float BloomIntensity : packoffset(c78.w) = {0.699999988};
  float GlareIntensity : packoffset(c79) = {1};
  float4 GameEdgeParameters : packoffset(c80) = {1,1,1,0.00300000003};
  float4 PointLightParams : packoffset(c81) = {0,0,0,0};
  float4 PointLightColor : packoffset(c82) = {0,0,0,0};
}
...
void main(
  ...
  float4 v8 : TEXCOORD5,  // DLAA: prevClip from replaced char VS
