...
cbuffer _Globals : register(b0)
{
  ...
  float ShadowReceiveOffset : packoffset(c71.w) = {0.600000024};
  float SphereMapIntensity : packoffset(c72) = {1};
  float BloomIntensity : packoffset(c72.y) = {0.699999988};
  float4 GameEdgeParameters : packoffset(c73) = {1,1,1,0.00300000003};
  float4 PointLightParams : packoffset(c74) = {0,0,0,0};
  float4 PointLightColor : packoffset(c75) = {0,0,0,0};
}
...
void main(
  ...
  float4 v7 : TEXCOORD5,  // DLAA: prevClip
