...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// GT-VBAO is based on GTAO/GTSO "Jimenez et al. / Practical Real-Time Strategies for Accurate Indirect Occlusion", 
// https://www.activision.com/cdn/research/Practical_Real_Time_Strategies_for_Accurate_Indirect_Occlusion_NEW%20VERSION_COLOR.pdf
// 
// Implementation:  Filip Strugar (filip.strugar@intel.com), Steve Mccalla <stephen.mccalla@intel.com>         (\_/)
// Version:         1.02                                                                                      (='.'=)
// Details:         https://github.com/GameTechDev/GT-VBAO                                                     (")_(")
//
// Version history:
...
//                    main GT-VBAO pass to reduce complexity and allow reuse; also quality of generated normals improved
...
// 1.22 (2021-09-28): Added 'GTVBAO_' prefix to all local functions to avoid name clashes with various user codebases.
// 1.30 (2021-10-10): Added support for directional component (bent normals).
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef __GT_VBAO_TYPES_H__
#define __GT_VBAO_TYPES_H__
...
namespace GTVBAO
{
    ...
    #define GT_VBAO_DEPTH_MIP_LEVELS                    5                   // this one is hard-coded to 5 for now
    #define GT_VBAO_NUMTHREADS_X                        8                   // these can be changed
    #define GT_VBAO_NUMTHREADS_Y                        8                   // these can be changed
    ...
    #ifndef GT_VBAO_USE_DEFAULT_CONSTANTS
    #define GT_VBAO_USE_DEFAULT_CONSTANTS 1
    #endif
    ...
    // set GT_VBAO_USE_DEFAULT_CONSTANTS and the code will compile into a more efficient shader
    #define GT_VBAO_DEFAULT_RADIUS_MULTIPLIER               (1.457f  )  // allows us to use different value as compared to ground truth radius to counter inherent screen space biases
    #define GT_VBAO_DEFAULT_FALLOFF_RANGE                   (0.615f  )  // distant samples contribute less
    #define GT_VBAO_DEFAULT_SAMPLE_DISTRIBUTION_POWER       (2.0f    )  // small crevices more important than big surfaces
    #define GT_VBAO_DEFAULT_THIN_OCCLUDER_COMPENSATION      (0.0f    )  // the new 'thickness heuristic' approach
    #define GT_VBAO_DEFAULT_FINAL_VALUE_POWER               (2.2f    )  // modifies the final ambient occlusion value using power function - this allows some of the above heuristics to do different things
    #define GT_VBAO_DEFAULT_DEPTH_MIP_SAMPLING_OFFSET       (3.30f   )  // main trade-off between performance (memory bandwidth) and quality (temporal stability is the first affected, thin objects next)

    #define GT_VBAO_OCCLUSION_TERM_SCALE                    (1.5f)      // for packing in UNORM (because raw, pre-denoised occlusion term can overshoot 1 but will later average out to 1)
    ...
    struct GTAOSettings
    {
        ...
        float       RadiusMultiplier                    = GT_VBAO_DEFAULT_RADIUS_MULTIPLIER;
        float       FalloffRange                        = GT_VBAO_DEFAULT_FALLOFF_RANGE;
        float       SampleDistributionPower             = GT_VBAO_DEFAULT_SAMPLE_DISTRIBUTION_POWER;
        float       ThinOccluderCompensation            = GT_VBAO_DEFAULT_THIN_OCCLUDER_COMPENSATION;    
        float       FinalValuePower                     = GT_VBAO_DEFAULT_FINAL_VALUE_POWER;
        float       DepthMIPSamplingOffset              = GT_VBAO_DEFAULT_DEPTH_MIP_SAMPLING_OFFSET;
    };
    ...
    inline void GTAOUpdateConstants( GT-VBAO::GTAOConstants& consts, int viewportWidth, int viewportHeight, const GT-VBAO::GTAOSettings & settings, const float projMatrix[16], bool rowMajor, unsigned int frameCounter )
    {
...
#ifdef IMGUI_API
    inline bool GTAOImGuiSettings( GT-VBAO::GTAOSettings & settings )
    {
