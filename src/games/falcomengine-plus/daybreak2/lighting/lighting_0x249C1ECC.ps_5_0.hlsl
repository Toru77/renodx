...
SamplerState SmplGeneral_s : register(s12);
  ...
  out uint4 o1 : SV_Target1)
{
  ...
  if (r18.x != 0) {
    ...
    if (r9.w != 0) {
      ...
      if (r12.w != 0) {
        ...
        r19.xy = float2(0.00124999997,0.000624999986) * r8.zz;
        r12.w = -6 + r13.z;
        r19.zw = r19.xy * r12.ww;
        r19.zw = r19.zw / r13.zz;
        r20.y = shadowMap.SampleLevel(SmplGeneral_s, r13.xy, 0).x;
        r12.w = cmp(r20.y < r13.z);
        r20.x = 1;
        r20.xy = r12.ww ? r20.xy : 0;
        ...
        r16.w = 0;
        while (true) {
          r17.w = cmp((int)r16.w >= 15);
          if (r17.w != 0) break;
          r17.w = (int)r16.w;
          r18.x = 0.5 + r17.w;
          r18.x = sqrt(r18.x);
          r18.x = 0.258198887 * r18.x;
          r17.w = r17.w * 2.4000001 + r12.w;
          sincos(r17.w, r21.x, r22.x);
          r22.x = r22.x * r18.x;
          r22.y = r21.x * r18.x;
          r21.xy = r22.xy * r19.zw + r13.xy;
          r17.w = shadowMap.SampleLevel(SmplGeneral_s, r21.xy, 0).x;
          r18.x = cmp(r17.w < r13.z);
          r21.y = r20.w + r17.w;
          r21.x = 1 + r20.z;
          r20.zw = r18.xx ? r21.xy : r20.zw;
          r16.w = (int)r16.w + 1;
        }
        r16.w = cmp(r20.z >= 1);
        if (r16.w != 0) {
          ...
          r16.w = 60 * r16.w;
          r19.xy = r16.ww * r19.xy;
          {
            uint smW, smH, smMips;
            shadowMap.GetDimensions(0, smW, smH, smMips);
            r19.zw = float2(0.333330005f, 0.333330005f) / float2(smW, smH);
          }
          r19.xy = max(r19.zw, r19.xy);
          r16.w = cmp(0.5 < r13.y);
      ...
      r16.w = r16.w * r8.z;
      r19.xy = float2(0.00124999997,0.000624999986) * r16.ww;
      r16.w = -6 + r13.z;
      r19.zw = r19.xy * r16.ww;
      r19.zw = r19.zw / r13.zz;
      r20.y = shadowMap.SampleLevel(SmplGeneral_s, r13.xy, 0).x;
      r16.w = cmp(r20.y < r13.z);
      r20.x = 1;
      r20.xy = r16.ww ? r20.xy : 0;
      ...
      r17.w = 0;
      while (true) {
        r18.x = cmp((int)r17.w >= 15);
        if (r18.x != 0) break;
        r18.x = (int)r17.w;
        r21.x = 0.5 + r18.x;
        r21.x = sqrt(r21.x);
        r21.x = 0.258198887 * r21.x;
        r18.x = r18.x * 2.4000001 + r16.w;
        sincos(r18.x, r18.x, r22.x);
        r22.x = r22.x * r21.x;
        r22.y = r21.x * r18.x;
        r21.xy = r22.xy * r19.zw + r13.xy;
        r18.x = shadowMap.SampleLevel(SmplGeneral_s, r21.xy, 0).x;
        r21.x = cmp(r18.x < r13.z);
        r22.y = r20.w + r18.x;
        r22.x = 1 + r20.z;
        r20.zw = r21.xx ? r22.xy : r20.zw;
        r17.w = (int)r17.w + 1;
      }
      r16.w = cmp(r20.z >= 1);
      if (r16.w != 0) {
      ...
      if (r12.w != 0) {
        ...
        r19.zw = r19.zw / r13.zz;
        r20.y = shadowMap.SampleLevel(SmplGeneral_s, r13.xy, 0).x;
        r8.z = cmp(r20.y < r13.z);
        r20.x = 1;
        r20.xy = r8.zz ? r20.xy : 0;
        ...
        r12.w = 0;
        while (true) {
          r16.w = cmp((int)r12.w >= 15);
          if (r16.w != 0) break;
          r16.w = (int)r12.w;
          r17.w = 0.5 + r16.w;
          r17.w = sqrt(r17.w);
          r17.w = 0.258198887 * r17.w;
          r16.w = r16.w * 2.4000001 + r8.z;
          sincos(r16.w, r18.x, r21.x);
          r21.x = r21.x * r17.w;
          r21.y = r18.x * r17.w;
          r21.xy = r21.xy * r19.zw + r13.xy;
          r16.w = shadowMap.SampleLevel(SmplGeneral_s, r21.xy, 0).x;
          r17.w = cmp(r16.w < r13.z);
          r21.y = r20.w + r16.w;
          r21.x = 1 + r20.z;
          r20.zw = r17.ww ? r21.xy : r20.zw;
          r12.w = (int)r12.w + 1;
        }
        r12.w = cmp(r20.z >= 1);
        if (r12.w != 0) {
          r12.w = r20.w / r20.z;
          r12.w = r13.z + -r12.w;
          r12.w = min(0.0500000007, r12.w);
          r12.w = 60 * r12.w;
          r19.xy = r12.ww * r19.xy;
          {
            uint smW, smH, smMips;
            shadowMap.GetDimensions(0, smW, smH, smMips);
            r19.zw = float2(0.333330005f, 0.333330005f) / float2(smW, smH);
          ...
          r16.w = 0;
          while (true) {
            r17.w = cmp((int)r16.w >= 16);
            if (r17.w != 0) break;
            r17.w = (int)r16.w;
            r18.x = 0.5 + r17.w;
            r18.x = sqrt(r18.x);
            r18.x = 0.25 * r18.x;
            r17.w = r17.w * 2.4000001 + r8.z;
            sincos(r17.w, r20.x, r21.x);
            r21.x = r21.x * r18.x;
            r21.y = r20.x * r18.x;
            r20.xy = r21.xy * r19.xy + r13.xy;
            r17.w = max(r20.y, r19.z);
            r20.z = min(r17.w, r19.w);
            r17.w = shadowMap.SampleCmpLevelZero(SmplShadow_s, r20.xz, r13.z).x;
            r12.w = r17.w + r12.w;
            r16.w = (int)r16.w + 1;
          }
          r8.z = 0.0625 * r12.w;
  ...
  r0.y = r2.z * r0.y;
  r0.zw = (uint2)r6.zw;
  o1.x = mad((int)r0.w, 0x00010000, (int)r0.z);
  {
