  ...
  out float2 o2 : SV_Target2)
{
  ...
  r2.w = v10.x ? -1 : 1;
  r4.x = dot(view_g._m02_m12_m22_m32, v8.xyzw);
  r4.yzw = lightProbe_g[1].xyz * r2.xxx + lightProbe_g[0].xyz;
  r4.yzw = lightProbe_g[2].xyz * r2.yyy + r4.yzw;
  r4.yzw = lightProbe_g[3].xyz * r2.zzz + r4.yzw;
  r5.xyz = lightProbe_g[4].xyz * r2.zzz;
  r4.yzw = r5.xyz * r2.xxx + r4.yzw;
  r5.xyz = lightProbe_g[5].xyz * r2.yyy;
  r4.yzw = r5.xyz * r2.zzz + r4.yzw;
  r5.xyz = lightProbe_g[6].xyz * r2.yyy;
  r4.yzw = r5.xyz * r2.xxx + r4.yzw;
  r5.xy = r2.zy * r2.zy;
  r5.x = r5.x * 3 + -1;
  r4.yzw = lightProbe_g[7].xyz * r5.xxx + r4.yzw;
  r5.x = r2.x * r2.x + -r5.y;
  r4.yzw = lightProbe_g[8].xyz * r5.xxx + r4.yzw;
  r5.xyz = sceneShadowColor_g.xyz + shadowColor_g.xyz;
  r5.xyz = min(float3(1,1,1), r5.xyz);
  r5.w = dot(r2.xyz, -lightDirection_g.xyz);
  r6.x = r5.w * r2.w;
  r6.y = dot(r2.xyz, r1.yzw);
  r6.z = cmp(shadowDistance_g >= -r4.x);
  if (r6.z != 0) {
    r6.z = cmp(-r4.x < shadowSplitDistance_g);
    r7.xyzw = r6.zzzz ? shadowMtx_g[0]._m00_m10_m20_m30 : shadowMtx_g[1]._m00_m10_m20_m30;
    r8.xyzw = r6.zzzz ? shadowMtx_g[0]._m01_m11_m21_m31 : shadowMtx_g[1]._m01_m11_m21_m31;
    r9.xyzw = r6.zzzz ? shadowMtx_g[0]._m02_m12_m22_m32 : shadowMtx_g[1]._m02_m12_m22_m32;
    r10.xyzw = r6.zzzz ? shadowMtx_g[0]._m03_m13_m23_m33 : shadowMtx_g[1]._m03_m13_m23_m33;
    r7.x = dot(v8.xyzw, r7.xyzw);
    r7.y = dot(v8.xyzw, r8.xyzw);
    r7.z = dot(v8.xyzw, r9.xyzw);
    r6.z = dot(v8.xyzw, r10.xyzw);
    r7.xyz = r7.xyz / r6.zzz;
    r6.zw = float2(0,0);
    while (true) {
      r7.w = cmp((int)r6.w >= 10);
      if (r7.w != 0) break;
      r8.xy = icb[r6.w+0].xy * invShadowSize_g.xy;
      r8.xy = saturate(r8.xy * float2(1.5,1.5) + r7.xy);
      r7.w = shadowMap.SampleCmpLevelZero(SmplShadow_s, r8.xy, r7.z).x;
      r6.z = r7.w * 0.100000001 + r6.z;
      r6.w = (int)r6.w + 1;
    }
    r6.w = -shadowFadeNear_g + -r4.x;
    r6.w = saturate(shadowFadeRangeInv_g * r6.w);
    r7.x = 1 + -r6.z;
    r6.z = r6.w * r7.x + r6.z;
  } else {
    r6.z = 1;
  ...
  r6.w = -1 + r6.z;
  r6.w = specularShadowFadeRatio_g * r6.w + 1;
  r2.w = -r5.w * r2.w + 1;
  r2.w = translucency_g * r2.w + r6.x;
  r2.w = r2.w * 0.5 + 0.5;
  r5.w = r2.w * r2.w;
  r2.w = -r2.w * r5.w + 1;
  r2.w = r2.w * r2.w + r6.z;
  ...
  r5.w = lightSpecularGlossiness_g * specularGlossiness0_g;
  r6.z = saturate(dot(r7.xyz, r2.xyz));
  r5.w = max(0.00100000005, r5.w);
  r6.z = log2(r6.z);
  r5.w = r6.z * r5.w;
  r5.w = exp2(r5.w);
  r5.w = r5.w * r6.w;
  r5.w = lightSpecularIntensity_g * r5.w;
  r7.xyz = specularColor_g.xyz * r5.www;
  r6.xz = r6.xx * float2(0.5,-0.5) + float2(0.5,0.5);
  r5.w = max(r6.x, r6.z);
  r5.w = r5.w + -r6.x;
  r5.w = translucency_g * r5.w + r6.x;
  r6.x = r6.y + r6.y;
  r1.yzw = r2.xyz * -r6.xxx + r1.yzw;
  {
    uint cubeDim;
    texEnvMap_g.GetDimensions(0, cubeDim, cubeDim, cubeDim);
    r6.x = (float)(cubeDim - 1);
  }
  r1.yzw = float3(r1.y, -r1.z, -r1.w);
  r6.x = roughness_g * r6.x;
  r1.yzw = texEnvMap_g.SampleLevel(SmplCube_s, r1.yzw, r6.x).xyz;
  r1.yzw *= lerp(1.0, 0.25, saturate(shader_injection_data.cubemap_improvements_enabled));
  r6.x = cmp(0 < fresnel0_g);
  r6.y = 1 + -abs(r6.y);
  r6.y = max(0, r6.y);
  r6.z = log2(r6.y);
  r6.z = fresnel0_g * r6.z;
  r6.z = exp2(r6.z);
  r6.x = r6.x ? r6.z : 1;
  r6.z = metalness_g * r6.x;
  r8.xyz = r3.xyz * r1.yzw + -r3.xyz;
  r3.xyz = r6.zzz * r8.xyz + r3.xyz;
  r6.z = dot(r1.yzw, float3(0.298999995,0.587000012,0.114));
  r6.w = roughness_g * -9 + 10;
  r6.z = log2(r6.z);
  r6.z = r6.w * r6.z;
  r6.z = exp2(r6.z);
  r6.w = 1 + -r6.z;
  r6.z = metalness_g * r6.w + r6.z;
  r1.yzw = r5.www * r1.yzw;
  r1.yzw = r1.yzw * r6.zzz;
  r1.yzw = r1.yzw * r6.xxx;
  r6.z = 1 + -roughness_g;
  r1.yzw = r6.zzz * r1.yzw;
  r1.yzw = r7.xyz * lightColor_g.xyz + r1.yzw;
  r2.w = r5.w * r2.w;
  r7.xyz = float3(1,1,1) + -r5.xyz;
  r5.xyz = r2.www * r7.xyz + r5.xyz;
  r4.yzw = r5.xyz * lightColor_g.xyz + r4.yzw;
  r2.w = min(1, emissive_g);
  r5.xyz = float3(1,1,1) + -r4.yzw;
  r4.yzw = r2.www * r5.xyz + r4.yzw;
  r2.w = rimIntensity_g * r6.y;
  r2.w = log2(r2.w);
  r2.w = rimLightPower_g * r2.w;
  r2.w = exp2(r2.w);
  r2.w = min(1, r2.w);
  r1.yzw = rimLightColor_g.xyz * r2.www + r1.yzw;
  r5.xy = v0.xy * float2(lightTileWidthInv_g, lightTileHeightInv_g);
  r2.w = lightTileDepthInv_g * -r4.x;
  r2.w = min(7, r2.w);
  r2.w = max(0, r2.w);
  r5.xy = (uint2)r5.xy;
  r2.w = (uint)r2.w;
  r5.y = (uint)r5.y << 5;
  r2.w = mad((int)r2.w, 576, (int)r5.y);
  r2.w = (int)r5.x + (int)r2.w;
  r2.w = min(4607, (uint)r2.w);
  r5.x = lightIndices_g[r2.w].pointLightCount;
  r5.x = min(63, (uint)r5.x);
  r5.yzw = float3(0,0,0);
  r6.yzw = float3(0,0,0);
  r7.x = 0;
  while (true) {
    r7.y = cmp((uint)r7.x >= (uint)r5.x);
    if (r7.y != 0) break;
    r7.y = lightIndices_g[r2.w].pointLightIndices[(int)r7.x];
  ...
  r4.yzw = r6.yzw * dynamicLightIntensity_g + r4.yzw;
  r5.x = lightIndices_g[r2.w].spotLightCount;
  r5.x = min(63, (uint)r5.x);
  r6.yzw = r5.yzw;
  r7.xyzw = float4(0,0,0,0);
  while (true) {
    r8.x = cmp((uint)r7.w >= (uint)r5.x);
    if (r8.x != 0) break;
    r8.x = lightIndices_g[r2.w].spotLightIndices[(int)r7.w];
    ...
    if (r9.z != 0) {
      ...
      if (r9.y != 0) {
        ...
        r6.yzw = r8.xyz * r10.xxx + r6.yzw;
      }
    }
    r7.w = (int)r7.w + 1;
  }
  r0.xyz = r7.xyz * dynamicLightIntensity_g + r4.yzw;
  r1.yzw = r6.yzw * dynamicLightIntensity_g + r1.yzw;
  ...
  r1.x = -r4.x / volumeCameraFarClip_g;
