  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (shader_injection_data.volfog_enabled < 0.5) {
    o0 = sceneColor;
    return;
  }
  ...
  float4 fogSample;
  if (shader_injection_data.volfog_tricubic_enabled > 0.5) {
  ...
  float volfog_fog_cc_strength = saturate(shader_injection_data.volfog_color_correction_strength);
  if (shader_injection_data.fog_color_correction_enabled > 0.5
      && volfog_fog_cc_strength > 0.001) {
    float3 extincted = sceneColor.xyz * fogSample.w;
    foggedColor = renodx::rendering::FogColorCorrection(
        extincted,
        fogSample.xyz,
        shader_injection_data.fog_hue,
        shader_injection_data.fog_chrominance,
        shader_injection_data.fog_avg_brightness,
        shader_injection_data.fog_min_brightness,
        shader_injection_data.fog_min_chroma_change,
        shader_injection_data.fog_max_chroma_change,
        shader_injection_data.fog_lightness_strength,
