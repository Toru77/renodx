// ---- Created with 3Dmigoto v1.4.1 on Sun Mar  8 20:18:38 2026
  ...
  out float2 o3 : SV_Target3)
{
  ...
  r4.w = v7.x ? -1 : 1;
  r5.w = emissive_g * r6.w;
  r6.w = dot(view_g._m02_m12_m22_m32, v3.xyzw);
  r7.xyz = lightProbe_g[1].xyz * r5.xxx + lightProbe_g[0].xyz;
  r7.xyz = lightProbe_g[2].xyz * r5.yyy + r7.xyz;
  r7.xyz = lightProbe_g[3].xyz * r5.zzz + r7.xyz;
  r8.xyz = lightProbe_g[4].xyz * r5.zzz;
  r7.xyz = r8.xyz * r5.xxx + r7.xyz;
  r8.xyz = lightProbe_g[5].xyz * r5.yyy;
  r7.xyz = r8.xyz * r5.zzz + r7.xyz;
  r8.xyz = lightProbe_g[6].xyz * r5.yyy;
  r7.xyz = r8.xyz * r5.xxx + r7.xyz;
  r8.xy = r5.zy * r5.zy;
  r7.w = r8.x * 3 + -1;
  ...
  r7.w = dot(r5.xyz, -lightDirection_g.xyz);
  r8.w = r7.w * r4.w;
  r9.x = dot(r5.xyz, r4.xyz);
  ...
  r2.y = cmp(r2.y < r2.x);
  if (r2.y != 0) {
    r10.x = dot(v3.xyzw, shadowMtx_g[2]._m00_m10_m20_m30);
    r10.y = dot(v3.xyzw, shadowMtx_g[2]._m01_m11_m21_m31);
    r10.z = dot(v3.xyzw, shadowMtx_g[2]._m02_m12_m22_m32);
    r2.y = dot(v3.xyzw, shadowMtx_g[2]._m03_m13_m23_m33);
    r9.yzw = r10.xyz / r2.yyy;
    r2.yz = cmp(r9.yz < float2(0,0));
    r10.xy = cmp(float2(1,1) < r9.yz);
    ...
    if (r2.y != 0) {
      ...
      r2.yz = float2(0,0);
      while (true) {
        r10.w = cmp((int)r2.z >= 10);
        if (r10.w != 0) break;
        r10.xy = saturate(icb[r2.z+4].xy * invShadowSize_g.xy + r9.yz);
        r10.x = shadowMaps.SampleCmpLevelZero(SmplShadow_s, r10.xyz, r9.w).x;
        r2.y = r10.x * 0.100000001 + r2.y;
        r2.z = (int)r2.z + 1;
      }
    }
    r2.z = cmp(r2.x < shadowSplitDistance_g.y);
    if (r2.z != 0) {
      r10.x = dot(v3.xyzw, shadowMtx_g[1]._m00_m10_m20_m30);
      r10.y = dot(v3.xyzw, shadowMtx_g[1]._m01_m11_m21_m31);
      r10.z = dot(v3.xyzw, shadowMtx_g[1]._m02_m12_m22_m32);
      r2.z = dot(v3.xyzw, shadowMtx_g[1]._m03_m13_m23_m33);
      r9.yzw = r10.xyz / r2.zzz;
      r10.z = 1;
      r2.z = 0;
      r10.w = 0;
      while (true) {
        ...
        r10.xy = saturate(r11.xy * float2(1.125,1.125) + r9.yz);
        r10.x = shadowMaps.SampleCmpLevelZero(SmplShadow_s, r10.xyz, r9.w).x;
        r2.z = r10.x * 0.100000001 + r2.z;
        r10.w = (int)r10.w + 1;
      }
      r9.y = shadowSplitDistance_g.y + -r2.x;
      r9.y = 0.200000003 * r9.y;
      r2.z = r2.z + -r2.y;
      r2.y = r9.y * r2.z + r2.y;
    }
    ...
    r9.yzw = r2.zzz ? float3(0,0,0) : float3(1,4,1);
    r10.x = dot(v3.xyzw, shadowMtx_g[r9.z/4]._m00_m10_m20_m30);
    r10.y = dot(v3.xyzw, shadowMtx_g[r9.z/4]._m01_m11_m21_m31);
    r10.z = dot(v3.xyzw, shadowMtx_g[r9.z/4]._m02_m12_m22_m32);
    r10.w = dot(v3.xyzw, shadowMtx_g[r9.z/4]._m03_m13_m23_m33);
    r10.xyz = r10.xyz / r10.www;
    r10.w = dot(float2(1.25,1.125), icb[r9.y+0].xy);
    r2.y = 0;
    r11.x = 0;
    while (true) {
      r11.y = cmp((int)r11.x >= 10);
      if (r11.y != 0) break;
      r11.yz = icb[r11.x+4].xy * invShadowSize_g.xy;
      r9.yz = saturate(r11.yz * r10.ww + r10.xy);
      r9.y = shadowMaps.SampleCmpLevelZero(SmplShadow_s, r9.yzw, r10.z).x;
      r2.y = r9.y * 0.100000001 + r2.y;
      r11.x = (int)r11.x + 1;
    }
    r9.y = shadowSplitDistance_g.x + -5;
    r9.y = cmp(r9.y < r2.x);
    r2.z = r2.z ? r9.y : 0;
    if (r2.z != 0) {
      r10.x = dot(v3.xyzw, shadowMtx_g[1]._m00_m10_m20_m30);
  ...
  r2.z = -r7.w * r4.w + 1;
  r2.z = translucency_g * r2.z + r8.w;
  r2.z = r2.z * 0.5 + 0.5;
  r7.w = r2.z * r2.z;
  r2.z = -r2.z * r7.w + 1;
  r2.y = r2.z * r2.z + r2.y;
  r2.y = min(1, r2.y);
  r9.yzw = r3.xyz * r2.www + -lightDirection_g.xyz;
  r2.z = dot(r9.yzw, r9.yzw);
  r2.z = rsqrt(r2.z);
  r9.yzw = r9.yzw * r2.zzz;
  r2.z = lightSpecularGlossiness_g * specularGlossiness0_g;
  r7.w = saturate(dot(r9.yzw, r5.xyz));
  ...
  r9.yzw = specularColor_g.xyz * r2.xxx;
  r2.xz = r8.ww * float2(0.5,-0.5) + float2(0.5,0.5);
  r2.z = max(r2.x, r2.z);
  r2.z = r2.z + -r2.x;
  ...
  r4.xyz *= lerp(1.0, 0.0, saturate(shader_injection_data.cubemap_improvements_enabled) * (kaiGlassDynOverride ? 0.0 : 1.0));
  ...
  r4.xyz = r9.yzw * lightColor_g.xyz + r4.xyz;
  r2.x = r2.x * r2.y;
  ...
  r6.x = lightIndices_g[r6.x].tileDepthInv;
  r6.x = -r6.w * r6.x;
  r6.x = min(7, r6.x);
  r6.x = max(0, r6.x);
  r6.x = (uint)r6.x;
  ...
  r2.y = lightIndices_g[r2.x].pointLightCount;
  ...
  while (true) {
    ...
    if (r6.y != 0) break;
    r6.y = lightIndices_g[r2.x].pointLightIndices[r6.x];
    r10.x = dynamicLights_g[r6.y].pos.x;
    r10.y = dynamicLights_g[r6.y].pos.y;
    r10.z = dynamicLights_g[r6.y].pos.z;
    r10.xyz = -v3.xyz + r10.xyz;
    r7.w = dot(r10.xyz, r10.xyz);
    r8.w = sqrt(r7.w);
    r9.w = dynamicLights_g[r6.y].radiusInv;
    r8.w = r9.w * r8.w;
    r9.w = dynamicLights_g[r6.y].attenuation;
    r8.w = log2(abs(r8.w));
    r8.w = r9.w * r8.w;
    r8.w = exp2(r8.w);
    r8.w = 1 + -r8.w;
    ...
    if (r9.w != 0) {
      ...
      r7.w = dynamicLights_g[r6.y].translucency;
      r9.w = dot(r10.xyz, r5.xyz);
      r7.w = max(r9.w, r7.w);
      r7.w = r8.w * r7.w;
      r11.x = dynamicLights_g[r6.y].color.x;
      r11.y = dynamicLights_g[r6.y].color.y;
      r11.z = dynamicLights_g[r6.y].color.z;
      r9.xyz = r11.xyz * r7.www + r9.xyz;
      r10.xyz = r3.xyz * r2.www + r10.xyz;
      r8.w = dot(r10.xyz, r10.xyz);
      r8.w = rsqrt(r8.w);
      r10.xyz = r10.xyz * r8.www;
      r12.x = dynamicLights_g[r6.y].specularIntensity;
      r12.y = dynamicLights_g[r6.y].specularGlossiness;
  ...
  r2.y = lightIndices_g[r2.x].spotLightCount;
  r2.y = min(63, (uint)r2.y);
  r9.xyz = r8.xyz;
  ...
  while (true) {
    r6.y = cmp((uint)r6.x >= (uint)r2.y);
    if (r6.y != 0) break;
    r6.y = lightIndices_g[r2.x].spotLightIndices[r6.x];
    r11.x = dynamicLights_g[r6.y].pos.x;
    r11.y = dynamicLights_g[r6.y].pos.y;
    r11.z = dynamicLights_g[r6.y].pos.z;
    r11.xyz = -v3.xyz + r11.xyz;
    r7.w = dot(r11.xyz, r11.xyz);
    r8.w = rsqrt(r7.w);
    r11.xyz = r11.xyz * r8.www;
    r12.x = dynamicLights_g[r6.y].vec.x;
    r12.y = dynamicLights_g[r6.y].vec.y;
    r12.z = dynamicLights_g[r6.y].vec.z;
    r12.w = dynamicLights_g[r6.y].spotAngleInv;
    r8.w = dot(r11.xyz, r12.xyz);
    r8.w = max(0, r8.w);
    r8.w = 1 + -r8.w;
    r8.w = r8.w * r12.w;
    r9.w = dynamicLights_g[r6.y].attenuationAngle;
    r8.w = log2(r8.w);
    r8.w = r9.w * r8.w;
    r8.w = exp2(r8.w);
    r8.w = 1 + -r8.w;
    ...
    if (r9.w != 0) {
      ...
      r8.w = cmp(0 < r7.w);
      if (r8.w != 0) {
        r12.x = dynamicLights_g[r6.y].translucency;
        r12.y = dynamicLights_g[r6.y].shadowmapIndex;
        r8.w = cmp((int)r12.y != -1);
        if (r8.w != 0) {
          r13.xyzw = spotShadowMatrices_g[r12.y]._m00_m10_m20_m30;
          r14.xyzw = spotShadowMatrices_g[r12.y]._m01_m11_m21_m31;
          r15.xyzw = spotShadowMatrices_g[r12.y]._m02_m12_m22_m32;
          r16.xyzw = spotShadowMatrices_g[r12.y]._m03_m13_m23_m33;
          ...
          r12.yzw = float3(0.00244140625,0,0) + r13.xyw;
          r9.w = spotShadowMaps.SampleCmpLevelZero(SmplShadow_s, r12.yzw, r13.z).x;
          r9.w = 0.200000003 * r9.w;
          r8.w = r8.w * 0.200000003 + r9.w;
          r12.yzw = float3(-0.00244140625,0,0) + r13.xyw;
          r9.w = spotShadowMaps.SampleCmpLevelZero(SmplShadow_s, r12.yzw, r13.z).x;
          r8.w = r9.w * 0.200000003 + r8.w;
          r12.yzw = float3(0,0.00244140625,0) + r13.xyw;
          r9.w = spotShadowMaps.SampleCmpLevelZero(SmplShadow_s, r12.yzw, r13.z).x;
          r8.w = r9.w * 0.200000003 + r8.w;
          r12.yzw = float3(0,-0.00244140625,0) + r13.xyw;
          r9.w = spotShadowMaps.SampleCmpLevelZero(SmplShadow_s, r12.yzw, r13.z).x;
        ...
        r8.w = dot(r11.xyz, r5.xyz);
        r8.w = max(r12.x, r8.w);
        r7.w = r8.w * r7.w;
        r12.x = dynamicLights_g[r6.y].color.x;
        r12.y = dynamicLights_g[r6.y].color.y;
        r12.z = dynamicLights_g[r6.y].color.z;
        r10.xyz = r12.xyz * r7.www + r10.xyz;
        r11.xyz = r3.xyz * r2.www + r11.xyz;
        r8.w = dot(r11.xyz, r11.xyz);
        r8.w = rsqrt(r8.w);
        r11.xyz = r11.xyz * r8.www;
        r13.x = dynamicLights_g[r6.y].specularIntensity;
        r13.y = dynamicLights_g[r6.y].specularGlossiness;
  ...
  r2.yzw = r5.xyz * r4.www;
  r1.x = -r3.x * fogIntensity_g + 1;
  r1.x = ssaoIntensity_g * r1.x;
  r1.y = min(abs(r2.z), abs(r2.y));
  r1.z = max(abs(r2.z), abs(r2.y));
  r1.z = 1 / r1.z;
  r1.xy = r1.xy * r1.wz;
  r1.z = r1.y * r1.y;
  r3.x = r1.z * 0.0208350997 + -0.0851330012;
  r3.x = r1.z * r3.x + 0.180141002;
  r3.x = r1.z * r3.x + -0.330299497;
  r1.z = r1.z * r3.x + 0.999866009;
  r3.x = r1.y * r1.z;
  ...
  r1.z = r1.z ? r2.y : 0;
  r1.y = r1.z ? -r1.y : r1.y;
  r2.x = 0.318309873 * r1.y;
  r1.yz = float2(1,1) + r2.xw;
