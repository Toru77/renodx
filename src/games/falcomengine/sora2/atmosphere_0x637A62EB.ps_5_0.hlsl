  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xy = (int2)r0.xy;
  r0.zw = float2(0,0);
  r0.x = mrtTexture0.Load(r0.xyz).w;
  r0.x = (int)r0.x & 1;
  r0.y = cmp((int)r0.x != 0);
  r0.xz = r0.xx ? chrIntensityLum_g.xy : intensityLum_g.xy;
  ...
  r1.xy = (int2)r1.xy;
  r1.zw = float2(0,0);
  r0.w = mrtTexture1.Load(r1.xyz).y;
  r0.w = (uint)r0.w;
  r1.x = cmp(0 >= r0.w);
  r0.w = 0.0392156877 * r0.w;
