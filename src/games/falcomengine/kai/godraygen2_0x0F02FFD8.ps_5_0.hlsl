  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xy = r0.xy * r0.zz;
  r0.zw = max(uvClamp_g.xy, r1.xy);
  r0.zw = min(uvClamp_g.zw, r0.zw);
  ...
  r2.xyzw = max(uvClamp_g.xyxy, r2.xyzw);
  r2.xyzw = min(uvClamp_g.zwzw, r2.xyzw);
  ...
  r0.xy = max(uvClamp_g.xy, r0.xy);
  r0.xy = min(uvClamp_g.zw, r0.xy);
