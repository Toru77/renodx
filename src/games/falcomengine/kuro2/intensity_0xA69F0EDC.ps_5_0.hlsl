...
{
  float fadeNear_g : packoffset(c0);
  float fadeRangeInv_g : packoffset(c0.y);
  float intensity_g : packoffset(c0.z);
}
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = r0.z / r0.x;
  r0.x = -fadeNear_g + -r0.x;
  r0.x = saturate(fadeRangeInv_g * r0.x);
  r0.x = intensity_g * r0.x;
