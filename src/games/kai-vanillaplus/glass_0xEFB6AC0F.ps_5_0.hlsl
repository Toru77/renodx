// ---- Created with 3Dmigoto v1.4.1 on Thu Mar 12 13:26:20 2026
  ...
  out float2 o3 : SV_Target3)
{
  ...
  r5.x = instances_g[v4.x].param.x;
  r5.y = instances_g[v4.x].param.y;
  r3.w = -r5.x + r3.w;
  r3.w = r3.w * r5.y;
  r3.w = min(1, r3.w);
  ...
  r4.w = rsqrt(r4.w);
  r7.xyz = v3.xyz * r4.www;
  r8.xy = v6.xy * float2(1,-1) + float2(0,1);
  r9.xyzw = Tex0.Sample(Smpl0_s, r8.xy).xyzw;
  r8.zw = int2(1,64) & swizzle_flags_g;
  r10.x = r9.x;
  r10.w = 1;
  r9.xyzw = r8.zzzz ? r10.xxxw : r9.xyzw;
  // Dehaze base glass texture (Tex0), toggled by cubemap improvements switch.
  r11.xyz = r9.xyz;
  r9.xyz = saturate((r9.xyz - 0.5) * 1.35 + 0.5);
  r10.w = dot(r9.xyz, float3(0.298999995,0.587000012,0.114));
  r9.xyz = lerp(r10.www, r9.xyz, 0.1);
  r9.xyz = pow(max(r9.xyz, 1e-4), 2);
  r11.w = saturate(sss_injection_data.cubemap_improvements_enabled);
  r9.xyz = lerp(r11.xyz, r9.xyz, r11.www);
  r10.xyz = Tex3.Sample(Smpl3_s, r8.xy).xyz;
  r10.xyz = r10.xyz * float3(2,2,2) + float3(-1,-1,-1);
  r7.xyz = r10.yyy * r7.xyz;
  r6.xyz = r10.xxx * r6.xyz + r7.xyz;
  r5.xyz = r10.zzz * r5.xyz + r6.xyz;
  r4.w = dot(r5.xyz, r5.xyz);
  r4.w = rsqrt(r4.w);
  r5.yzw = r5.xyz * r4.www;
  r6.xyzw = Tex6.Sample(Smpl6_s, r8.xy).xyzw;
  r7.x = r6.x;
  r7.w = 1;
  r6.xyzw = r8.wwww ? r7.xxxw : r6.xyzw;
  r1.xyzw = r9.xyzw * r1.xyzw;
  r4.w = emissive_g * r6.w;
  r6.w = dot(view_g._m02_m12_m22_m32, v5.xyzw);
  ...
  r2.y = cmp(r2.y < r2.x);
  if (r2.y != 0) {
    r9.x = dot(v5.xyzw, shadowMtx_g[2]._m00_m10_m20_m30);
    r9.y = dot(v5.xyzw, shadowMtx_g[2]._m01_m11_m21_m31);
    r9.z = dot(v5.xyzw, shadowMtx_g[2]._m02_m12_m22_m32);
    r2.y = dot(v5.xyzw, shadowMtx_g[2]._m03_m13_m23_m33);
    ...
    if (r2.z != 0) {
      r9.x = dot(v5.xyzw, shadowMtx_g[1]._m00_m10_m20_m30);
      r9.y = dot(v5.xyzw, shadowMtx_g[1]._m01_m11_m21_m31);
      r9.z = dot(v5.xyzw, shadowMtx_g[1]._m02_m12_m22_m32);
      r2.z = dot(v5.xyzw, shadowMtx_g[1]._m03_m13_m23_m33);
    ...
    r10.x = dot(v5.xyzw, shadowMtx_g[r9.y/4]._m00_m10_m20_m30);
    r10.y = dot(v5.xyzw, shadowMtx_g[r9.y/4]._m01_m11_m21_m31);
    r10.z = dot(v5.xyzw, shadowMtx_g[r9.y/4]._m02_m12_m22_m32);
    r9.w = dot(v5.xyzw, shadowMtx_g[r9.y/4]._m03_m13_m23_m33);
  ...
  r4.xyz *= lerp(1.0, 0.25, saturate(sss_injection_data.cubemap_improvements_enabled));
    ...
    if (r9.w != 0) {
      ...
      if (r8.w != 0) {
        ...
        if (r8.w != 0) {
          ...
          r13.x = dot(v5.xyzw, r13.xyzw);
          r13.y = dot(v5.xyzw, r14.xyzw);
          r13.z = dot(v5.xyzw, r15.xyzw);
          r8.w = dot(v5.xyzw, r16.xyzw);
