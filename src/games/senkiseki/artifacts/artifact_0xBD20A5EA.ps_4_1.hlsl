// ---- Created with 3Dmigoto v1.3.16 on Sat Sep 06 05:45:44 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float2 ProjectionScale : packoffset(c88) = {1,1};
  float BloomIntensity : packoffset(c88.z) = {1};
  float MaskEps : packoffset(c88.w);
