...
struct ShaderInjectData {
  ...
  float debug_disable_filter;
  float debug_disable_fading;
  float gi_intensity;
...
#define RENODX_TONE_MAP_TYPE                 ((shader_injection.tone_map_type == 1.f) ? 1.f : ((shader_injection.tone_map_type == 2.f) ? 3.f : shader_injection.tone_map_type))
#define RENODX_PEAK_WHITE_NITS               shader_injection.peak_white_nits
#define RENODX_DIFFUSE_WHITE_NITS            shader_injection.diffuse_white_nits
#define RENODX_GRAPHICS_WHITE_NITS           shader_injection.graphics_white_nits
#define RENODX_GAMMA_CORRECTION              ((shader_injection.gamma_correction == 3.f) ? 1.f : shader_injection.gamma_correction)
...
#define RENODX_SWAP_CHAIN_GAMMA_CORRECTION   ((shader_injection.swap_chain_gamma_correction == 3.f) ? 1.f : shader_injection.swap_chain_gamma_correction)
