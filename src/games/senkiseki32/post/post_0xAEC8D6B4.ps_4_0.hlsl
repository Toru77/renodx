// 0xAEC8D6B4 - post with glow, filter, fade color
#include "../shared.h"
#include "../common.hlsl"
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  o0.rgb = ApplyRenoDX_FilterFadeColor(color, glare, filterTex.rgb * FilterColor.rgb, filterTex.a * FilterColor.a,
                                       ToneFactor.xxx, GlowIntensity.w, FadingColor);
  o0.a = 1.0;
}
