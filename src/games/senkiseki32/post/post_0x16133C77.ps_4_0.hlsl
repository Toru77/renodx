// 0x16133C77 - post with glow, filter, DOF, fade texture
#include "../shared.h"
#include "../common.hlsl"
...
Texture2DMS<float4,4> DepthBuffer : register(t4);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  o0.rgb = ApplyRenoDX_FilterDofFadeTex_Vanilla(color, glare, filterTex.rgb * FilterColor.rgb, filterTex.a * FilterColor.a,
