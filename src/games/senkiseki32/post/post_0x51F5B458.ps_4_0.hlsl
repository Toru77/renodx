// 0x51F5B458 - post with glow, filter, monotone, fade texture
#include "../shared.h"
#include "../common.hlsl"
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  o0.rgb = ApplyRenoDX_FilterMonoFadeTex(color, glare, filterTex.rgb * FilterColor.rgb, filterTex.a * FilterColor.a,
