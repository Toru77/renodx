...
#define RENODX_INTERMEDIATE_SCALING               (RENODX_DIFFUSE_WHITE_NITS / 80.f)
...
struct ShaderInjectData {
  ...
  // Keep compatibility with proxy shaders in this folder.
...
#define RENODX_COLOR_GRADE_HIGHLIGHTS_VERSION shader_injection.tone_map_highlight_saturation
